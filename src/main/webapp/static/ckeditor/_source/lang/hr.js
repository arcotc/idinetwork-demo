...
CKEDITOR.lang['hr'] =
{
	...
	common :
	{
		...
		confirmNewPage	: 'Sve napravljene promjene ?e biti izgubljene ukoliko ih niste snimili. Sigurno želite u?itati novu stranicu?',
	...
	findAndReplace :
	{
		...
		notFoundMsg			: 'Traženi tekst nije prona?en.',
	...
	table :
	{
		...
		cell :
		{
			...
			yes				: 'Da',
			no				: 'ne',
			invalidWidth	: 'Širina ?elije mora biti broj.',
	...
	spellCheck :
	{
		...
		errorLoading	: 'Greška u?itavanja aplikacije: %s.',
		...
		oneChange		: 'Provjera završena: Jedna rije? promjenjena',
		manyChanges		: 'Provjera završena: Promijenjeno %1 rije?i',
	...
	{
		title		: 'Zalijepi',
		cutError	: 'Sigurnosne postavke Vašeg pretraživa?a ne dozvoljavaju operacije automatskog izrezivanja. Molimo koristite kraticu na tipkovnici (Ctrl/Cmd+X).',
		copyError	: 'Sigurnosne postavke Vašeg pretraživa?a ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tipkovnici (Ctrl/Cmd+C).',
		...
		securityMsg	: 'Zbog sigurnosnih postavki Vašeg pretraživa?a, editor nema direktan pristup Vašem me?uspremniku. Potrebno je ponovno zalijepiti tekst u ovaj prozor.',
		pasteArea	: 'Paste Area' // MISSING
	},

	pastefromword :
	{
		confirmCleanup	: 'Tekst koji želite zalijepiti ?ini se da je kopiran iz Worda. Želite li prije o?istiti tekst?',
	...
	templates :
	{
		...
		selectPromptMsg	: 'Molimo odaberite predložak koji želite otvoriti<br>(stvarni sadržaj ?e biti izgubljen):',
