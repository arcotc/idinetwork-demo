...
CKEDITOR.lang['eo'] =
{
	...
	table :
	{
		...
		cellSpace	: 'Interspacigo de ?eloj',
		cellPad		: '?irka?enhava Plenigado',
		caption		: 'Titolo',
		...
		cell :
		{
			...
			deleteCell		: 'Forigi ?elojn',
			merge			: 'Kunfandi ?elojn',
	...
	spellCheck :
	{
		...
		changeTo		: '?an?i al',
		btnIgnore		: 'Malatenti',
		btnIgnoreAll	: 'Malatenti ?iun',
		btnReplace		: 'Anstata?igi',
		btnReplaceAll	: 'Anstata?igi ?iun',
		btnUndo			: 'Malfari',
		noSuggestions	: '- Neniu propono -',
		progress		: 'Literumkontrolado da?ras...',
		noMispell		: 'Literumkontrolado finita: neniu fu?o trovita',
		noChanges		: 'Literumkontrolado finita: neniu vorto ?an?ita',
		oneChange		: 'Literumkontrolado finita: unu vorto ?an?ita',
		manyChanges		: 'Literumkontrolado finita: %1 vortoj ?an?itaj',
