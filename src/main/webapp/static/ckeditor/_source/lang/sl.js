...
CKEDITOR.lang['sl'] =
{
	...
	horizontalrule	: 'Vstavi vodoravno ?rto',
	...
	table :
	{
		...
		headersBoth		: 'Oboje',
		invalidRows		: 'Število vrstic mora biti ve?je od 0.',
		invalidCols		: 'Število stolpcev mora biti ve?je od 0.',
	...
	textfield :
	{
		...
		value		: 'Vrednost',
		charWidth	: 'Dolžina',
		maxChars	: 'Najve?je število znakov',
		type		: 'Tip',
		typeText	: 'Besedilo',
		typePass	: 'Geslo'
	},
	...
	flash :
	{
		...
		validateVSpace	: 'Navpi?ni razmik mora biti število.'
	},
	...
	spellCheck :
	{
		...
		ieSpellDownload	: '?rkovalnik ni nameš?en. Ali ga želite prenesti sedaj?'
	},
	...
	numberedlist	: 'Oštevil?en seznam',
	...
	{
		title		: 'Prilepi',
		cutError	: 'Varnostne nastavitve brskalnika ne dopuš?ajo samodejnega izrezovanja. Uporabite kombinacijo tipk na tipkovnici (Ctrl/Cmd+X).',
		copyError	: 'Varnostne nastavitve brskalnika ne dopuš?ajo samodejnega kopiranja. Uporabite kombinacijo tipk na tipkovnici (Ctrl/Cmd+C).',
		pasteMsg	: 'Prosim prilepite v sle?i okvir s pomo?jo tipkovnice (<STRONG>Ctrl/Cmd+V</STRONG>) in pritisnite <STRONG>V redu</STRONG>.',
		securityMsg	: 'Zaradi varnostnih nastavitev vašega brskalnika urejevalnik ne more neposredno dostopati do odložiš?a. Vsebino odložiš?a ponovno prilepite v to okno.',
	...
	about :
	{
		...
		moreInfo	: 'Za informacijo o licenci prostim obiš?ite našo spletno stran:',
