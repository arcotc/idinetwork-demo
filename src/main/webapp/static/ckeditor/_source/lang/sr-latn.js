...
CKEDITOR.lang['sr-latn'] =
{
	...
	spellCheck :
	{
		...
		oneChange		: 'Provera spelovanja završena: Izmenjena je jedna re?',
		manyChanges		: 'Provera spelovanja završena: %1 re?(i) je izmenjeno',
	...
	{
		title		: 'Zalepi',
		cutError	: 'Sigurnosna podešavanja Vašeg pretraživa?a ne dozvoljavaju operacije automatskog isecanja teksta. Molimo Vas da koristite pre?icu sa tastature (Ctrl/Cmd+X).',
		copyError	: 'Sigurnosna podešavanja Vašeg pretraživa?a ne dozvoljavaju operacije automatskog kopiranja teksta. Molimo Vas da koristite pre?icu sa tastature (Ctrl/Cmd+C).',
